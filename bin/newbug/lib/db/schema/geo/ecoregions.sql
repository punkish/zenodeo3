...
CREATE TABLE IF NOT EXISTS "ecoregionsGeopoly_rowid"(rowid INTEGER PRIMARY KEY,nodeno,a0,a1,a2,a3);
...
CREATE INDEX ix_ecoregions_id_ecoregionsPolygons ON ecoregionsPolygons(ecoregions_id);