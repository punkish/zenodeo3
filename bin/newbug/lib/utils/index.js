...
export default class NewbugUtils extends Newbug {
    ...
    getArchiveNameAndTimestamp = (typeOfArchive, d = new Date()) => {
    ...
    getTypeOfArchive = (archive_name) => archive_name
        .split('.')
        .slice(2, 3)[0];
    
    getLastUpdate = (typeOfArchive) => {
        const etl_updates = [
            {
                archive: 'yearly',
                last_update: '2022'
