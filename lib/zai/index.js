...
async function answerFromZai({ 
    ...
    const systemPrompt = `You are a scientific assistant specializing in biological research. 
Answer questions accurately based ONLY on the provided research papers.
