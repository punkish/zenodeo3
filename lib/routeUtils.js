...
const getDataFromZenodeo = async ({ request, resource, fastify }) => {
    ...
    if (result.count) {
        ...
        if (queries.yearlyCounts) {
            ...
            // TO FIX: this is a temporary solution until 'articles' are 
            // normalized and extracted into their own table. For, yearlyCounts
            // queries for treatments and articles are done together
            // if (typeof(queries.yearlyCounts) === 'object') {
            //     const { sql_treatments, sql_articles } = queries.yearlyCounts;

            //     const res1 = _sqlRunner(sql_treatments, runparams, fastify);
            //     const res_treatments = res1.res;
            //     const runtime_treatments = res1.runtime;

            //     const res2 = _sqlRunner(sql_articles, runparams, fastify);
            //     const res_articles = res2.res;
            //     const runtime_articles = res2.runtime;

            //     result.yearlyCounts = {
            //         treatments: res_treatments,
            ...
            //         debug.yearlyCounts = {
            //             treatments: { 
            //                 query: sql_treatments, 
            //                 runtime: runtime_treatments 
            //             },
            //             articles: { 
            //                 query: sql_articles, 
            //                 runtime: runtime_articles 
            //             }
            //         }
            //     }
            // }
            // else {
                const { res, runtime } = _sqlRunner(queries.yearlyCounts, runparams, fastify);

                result.yearlyCounts = res;
    
                if (config.isDebug) {
                    debug.yearlyCounts = { query: queries.yearlyCounts, runtime }
                }
            // }
