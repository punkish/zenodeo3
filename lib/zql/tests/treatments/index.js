export const sampleQueries = [
    ...
    //3: date
    {
        "desc": "new species checked in since 2024-01-01",
        "input": {
            "resource": "treatments",
            "searchparams": "status=sp.+nov.&checkinTime=since(2022-02-21)"
        },
        "output": {
            "queries": {
    ...
    //23
    {
        "desc": "checkinTime since 2024-01-01",
        "input": {
            "resource": "treatments",
            "searchparams": "checkinTime=since(2024-01-01)"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //29
    {
        "desc": "treatment with a specific treatmentId",
        "input": {
            "resource": "treatments",
            "searchparams": "treatmentId=565XDADF565XDADF565XDADF565XDADF"
        },
        "output": {
            "queries": {
                "main": {
    ...
    // 30
    {
        desc: `count with a constraint`,
        input: {
            resource: 'treatments',
            searchparams: 'cols=&treatmentTitle=ne( Cephalonomia tarsalis Ashmead 1893)'
        },
        output: {
            "queries": {
                "count": `SELECT Count(*) AS num_of_records FROM treatments`,
