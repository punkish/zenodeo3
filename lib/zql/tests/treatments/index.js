export const sampleQueries = [
    ...
    //0: geolocation
    {
        desc: `treatm: within a bounding box`,
        input: {
            resource: 'treatments',
    ...
    //1: number
    {
        desc: 'treatm: specific treatmentVersion',
        input: {
            resource: 'treatments',
    ...
    //4: date
    {
        "desc": "treatm: checkinTime until 2022-02-21",
        "input": {
            "resource": "treatments",
    ...
    //5: date
    {
        "desc": "treatm: checkinTime between 2022-02-21 and 2023-02-21",
        "input": {
            "resource": "treatments",
    ...
    //6: year
    {
        desc: 'treatm: given journal year',
        input: {
            resource: 'treatments',
