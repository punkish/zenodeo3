...
const test = () => {
    ...
    // count of material citations with location
    // const query = {
    //     resource: 'materialsCitations',
    //     params: {
    //         validGeo: 1,
    ...
    query = {
        resource: 'materialsCitations',
        searchparams: 'validGeo=1&cols=treatmentId&cols=longitude&cols=latitude&cols=isOnLand&size=1000'
    }
    ...
    query = {
        resource: 'treatments',
        searchparams: 'checkinTime=since(2018-12-03)'
    }
}
