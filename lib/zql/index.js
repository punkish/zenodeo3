...
// const searchparams = 'q=phylogeny&captionText=phylogeny&page=1&size=30&httpUri=ne()&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=captionText';
// console.log(preZql({resource, searchparams}))
