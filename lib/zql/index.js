...
const test = ({ resource, searchparams }) => {
    ...
    console.log(sqlFormatter.format(res.queries.main.count));
    console.log(sqlFormatter.format(res.queries.main.full));
}

const resource = 'bibRefCitations';
//const searchparams = 'q=phylogeny&page=1&size=30&httpUri=ne()&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=captionText';
const searchparams = 'q=phylogeny';
//test({ resource, searchparams });
