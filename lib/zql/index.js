...
const queries = ({resource, params}) => {
    ...
    // countSql is always created, and we don't need sortorder and limit for it
...
//     resource: 'treatments',
//     params: { 
//         location: 'containedIn({lowerLeft:{lat:40.78885994449482,lng:11.601562500000002},upperRight:{lat:47.931066347509784,lng:26.960449218750004}})',
//         size: 1000,
//         cols: ['treatmentTitle','latitude','longitude', 'isOnLand']
//     }
// })
...
//     resource: 'materialsCitations',
//     params: { 
//         geolocation: 'containedIn({lowerLeft:{lat:40.78885994449482,lng:11.601562500000002},upperRight:{lat:47.931066347509784,lng:26.960449218750004}})',
//         size: 1000,
//         cols: ['treatmentId','latitude','longitude', 'isOnLand']
//     }
// })
