...
if (nodePath === modulePath) {
    const inputs = [
        ...
        {
            "resource": "treatments",
            "searchparams": "cols=isOnLand&cols=treatmentId&size=1000&geolocation=contained_in(lower_left:{lat:-12.168225677390119,lng:-27.773437500000004},upper_right:{lat:12.168225677390119,lng:27.773437500000004})"
        },
