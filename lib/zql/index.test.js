...
const ocellusQueries = [
        ...
        output: {
            "queries": {
                "main": {
                    ...
                    "full": "SELECT treatments.treatmentId, httpUri, figureCitations.captionText FROM treatments JOIN figureCitations ON treatments.treatmentId = figureCitations.treatmentId WHERE treatments.treatmentId = '03849624FF8CFFE3FF30FAAAD0E6FA0D'"
                },
                "related": {},
                "facets": {}
            },
        ...
        "output": {
            "queries": {
                "main": {
                    ...
                    "full": "SELECT figureCitations.figureCitationId, httpUri, figureCitations.captionText FROM figureCitations WHERE figureCitations.treatmentId = @treatmentId ORDER BY figureCitations.figureCitationId ASC LIMIT 30 OFFSET 0"
                },
                "related": {},
                "facets": {}
            },
        ...
        "output": {
            "queries": {
                "main": {
                    ...
                    "full": "SELECT treatments.treatmentId, httpUri, figureCitations.captionText FROM treatments JOIN figureCitations ON treatments.treatmentId = figureCitations.treatmentId JOIN vtreatments ON treatments.treatmentId = vtreatments.treatmentId WHERE vtreatments MATCH @q AND Lower(httpUri) != @httpUri AND treatments.deleted = 0 ORDER BY treatments.treatmentId ASC LIMIT 30 OFFSET 0"
                },
                "related": {},
                "facets": {}
            },
    ...
    },
    {
        ...
        "output": {
            "queries": {
                "main": {
                    "count": "SELECT Count(DISTINCT treatments.treatmentId) AS num_of_records FROM treatments WHERE checkinTime >= strftime('%s', @date) * 1000 AND treatments.deleted = 0",
    ...
    },
    {
        ...
        "output": {
            "queries": {
                "main": {
                    "count": "SELECT Count(DISTINCT treatments.treatmentId) AS num_of_records FROM treatments JOIN vtreatments ON treatments.treatmentId = vtreatments.treatmentId WHERE vtreatments MATCH @q AND Lower(authorityName) LIKE @authorityName AND treatments.deleted = 0",
    ...
    },
    {
        ...
        "output": {
            "queries": {
                "main": {
                    "count": "SELECT Count(DISTINCT treatments.treatmentId) AS num_of_records FROM treatments WHERE Lower(treatmentTitle) LIKE @treatmentTitle AND treatments.deleted = 0",
    ...
    },
    {
        ...
        "output": {
            "queries": {
                "main": {
                    "count": "SELECT Count(DISTINCT treatments.treatmentId) AS num_of_records FROM treatments WHERE Lower(treatmentTitle) = @treatmentTitle AND treatments.deleted = 0",
