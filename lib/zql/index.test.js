...
import { 
    imageQueries, treatmentQueries, foreignKeys, ecoregionQueries 
} from './tests/index.js';
...
node lib/zql/index.test.js --format=true --results=true --list=true queryNum
