export const sampleQueries = [
    ...
    //0
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "cols=&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //1
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "captionText=phylogeny&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //2
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "q=phylogeny AND plantae&cols=treatments_id&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
    ...
    //3
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "checkinTime=between(2010-12-27 and 2021-12-27)&yearlyCounts=true"
        },
        "output": {
            "queries": {
    ...
    //4
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "journalTitle=eq(European Journal of Taxonomy)&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
    ...
    //5
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "order=coleoptera&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
    ...
    //6
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "class=Actinopterygii&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //7
    {
        ...
        input: {
            resource: 'images',
            searchparams: "family=Formicidae&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        output: {
            "queries": {
                "main": {
    ...
    //8
    {
        ...
        input: {
            resource: 'images',
            searchparams: 'treatmentId=000040332F2853C295734E7BD4190F05&cols=httpUri&cols=caption&yearlyCounts=true'
        },
        output: {
            "queries": {
                "main": {
    ...
    //9
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "articleDOI=10.11646/zootaxa.5284.3.7&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //10
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "articleTitle=starts_with(Morphology and taxonomic assessment)&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //11
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "articleTitle=Morphology and taxonomic assessment*&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //12
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "class=Actinopterygii&publicationDate=since(2021-12-21)&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //13
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "q=decapoda&journalTitle=not_like(zootaxa)&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //14
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "articleAuthor=agosti&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //15
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "authorityName=miller&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //16
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "phylum=starts_with(mol)&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //17
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "treatmentDOI=10.5281/zenodo.3854768&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //18
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "journalYear=1998&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //19
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "checkinTime=since(2023-05-24)&yearlyCounts=true"
        },
        "output": {
            "queries": {
    ...
    //20
    {
        ...
        "input": {
            "resource": "images",
            "searchparams": "geolocation=within(radius:10, units:'kilometers',lat:40.21,lng:-120.33)&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=httpUri&cols=caption&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    // 21
    {
        "desc": "images from a biome",
        "input": {
            "resource": "images",
            "searchparams": "biome=pampas&yearlyCounts=true"
        },
        "output": {
            "queries": {
                "main": {
    ...
    //22
    // breaks the test because no record is returned
    // {
    //     "desc": "images from Flooded Grasslands and Savannas",
    //     "input": {
    //         "resource": "images",
    //         "searchparams": "biome=Flooded%20Grasslands%20and%20Savannas&page=1&size=30&cols=treatmentId&cols=treatmentTitle&cols=zenodoDep&cols=treatmentDOI&cols=articleTitle&cols=articleAuthor&cols=httpUri&cols=caption"
    //     },
    //     "output": {
    //         "queries": {
    //             "main": {
    ...
    //         },
    //         "runparams": {
    //             "biome": "Flooded%20Grasslands%20and%20Savannas"
    //         }
    //     }
    // },
