...
export const mainQueries = ({ resource, params }) => {
    ...
    // to calculate the constraints. The following array has to be sorted
    //
    ...
    const cond = nonSqlCols.length === paramKeys.length && nonSqlCols.every((value, index) => value === paramKeys[index]);
