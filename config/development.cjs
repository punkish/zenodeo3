    ...
    "cronQueries": {
        ...
        "queries" : {
            "images": [
                ...
                `family=Formicidae&yearlyCounts=true`,
                `class=Actinopterygii&yearlyCounts=true`,
                `class=Arachnida&yearlyCounts=true`,
                `class=Malacostraca&yearlyCounts=true`,
                `order=Coleoptera&yearlyCounts=true`,
                `captionText=phylogeny&yearlyCounts=true`,
                `q=phylogeny&termFreq=true&yearlyCounts=true`,
                `q=phylogeny AND plantae&yearlyCounts=true`,
                `journalTitle=eq(European Journal of Taxonomy)&yearlyCounts=true`,
                `articleDOI=10.11646/zootaxa.5284.3.7&yearlyCounts=true`,
                `articleTitle=starts_with(Morphology and taxonomic assessment)&yearlyCounts=true`,
                `geolocation=within(radius:10, units:'kilometers', lat:40.21, lng:-120.33)&yearlyCounts=true`,
                `class=Actinopterygii&publicationDate=since(2021-12-21)&yearlyCounts=true`,
                `checkinTime=since(yesterday)&yearlyCounts=true`,
                `q=tyrannosaurus&authorityName=Osborn&yearlyCounts=true`,
                `family=Agamidae&yearlyCounts=true`,
                `q=moloch OR horridus&yearlyCounts=true`,
                `q=decapoda&journalTitle=not_like(zootaxa)&yearlyCounts=true`,
                `biome=savanna&yearlyCounts=true`,
                `biome=veld&yearlyCounts=true`,
                `biome=pampas&yearlyCounts=true`,
                `biome=Tundra&yearlyCounts=true`,
                `biome=Tropical and Subtropical Moist Broadleaf Forests&yearlyCounts=true`,
                `biome=Mediterranean Forests, Woodlands and Scrub&yearlyCounts=true`,
                `biome=Deserts and Xeric Shrublands&yearlyCounts=true`,
                `biome=Temperate Grasslands, Savannas and Shrublands&yearlyCounts=true`,
                `biome=Boreal Forests or Taiga&yearlyCounts=true`,
                `biome=Temperate Conifer Forests&yearlyCounts=true`,
                `biome=Temperate Broadleaf and Mixed Forests&yearlyCounts=true`,
                `biome=Montane Grasslands and Shrublands&yearlyCounts=true`,
                `biome=Mangroves&yearlyCounts=true`,
                `biome=Flooded Grasslands and Savannas&yearlyCounts=true`,
                `biome=Tropical and Subtropical Grasslands, Savannas and Shrublands&yearlyCounts=true`,
                `biome=Tropical and Subtropical Dry Broadleaf Forests&yearlyCounts=true`,
                `biome=Tropical and Subtropical Coniferous Forests&yearlyCounts=true`
            ],
            "treatments": [
                `cols=&yearlyCounts=true`
            ],
